			...
			<div class="main-content-inner">
					<div class="breadcrumbs" id="breadcrumbs">
						...
						<ul class="breadcrumb">
							...
							<li class="active">View Staff Records</li>
						</ul><!-- /.breadcrumb -->
...
if (isset($_GET['viewid'])){
	...
	?>																</span>
															...
															<div class="widget-box transparent">
																<div class="widget-header widget-header-small">
																	<h4 class="widget-title smaller">
																		...
																		<div class="profile-user-info">
																			<div class="profile-info-row">
																				<div class="profile-info-name"> <b>Qualification :</b></div>
																					<div class="profile-info-value">
																						<span><?php echo $qualification;?></span>
																					</div>
																			</div>
																			<div class="profile-info-row">
																				<div class="profile-info-name"> <b>Proficiency:</b></div>
																					<div class="profile-info-value">
												...
												<div class="hr hr-8 dotted"></div>
												<div class="center">
													<form action="revokestf.php" method="post">
														<input type="hidden" name="phone_nor" value="<?php echo $phone_no;?>">
