					...
					<div class="breadcrumbs" id="breadcrumbs">
						...
						<ul class="breadcrumb">
							<li>
								...
								<li class="active">Revoke Student Allocation</li>
							</li>
					...
					<div class="col-md-6 col-xs-offset-3">
						...
						<div class="row">
							<div class="col-md-6 col-xs-offset-1">
								<form action="studentrevokedetails.php" method="post" role="">
									<table border="0" cellspacing="0" cellpadding="0">
										...
										<tr>
											...
											<div class="form-group">
												<td>
													<label><b> Select Student Admission Number :</b></label>
												</td>
												<td>
													<?php
...
echo '<select name="admission_no" style="width:268px">';
...
echo '</select>';
	?>
										...
										<tr>
											...
											<div class="form-group">
												<td>
													<input name="submit" type="submit" class="btn btn-lg btn-success" value="View Student Allocation Details">
												</td>
											</div>
										</tr>
									</table>
