...
?>
					...
					<div class="page-content">
						...
						<div class="row">
							<div class="col-xs-12">
								...
								<div class="row">
									<div class="col-xs-12">
										<h3 class="header smaller lighter blue">Students & Staff Revoked details</h3>

										<div class="clearfix">
											<div class="pull-right tableTools-container"></div>
										</div>
										<div class="table-header">
											 Results for Revoking Details
										</div>
											...
											<table id="dynamic-table" class="table table-striped table-bordered table-hover">
												<thead>
													<tr>
                                                        ...
                                                        <th class="hidden-480">Date of Revoking</th>
 ...
 $stm= "SELECT * FROM revoking ORDER BY id";
...
?>
				...
				<div class="row">
	<div class="center">
														<a href="revokeallocation.php" type="button" class="btn btn-sm btn-primary btn-white btn-round">
															<i class="ace-icon fa fa-plus bigger-150 middle orange2"></i>
															<span class="bigger-110">Revoke User</span>
